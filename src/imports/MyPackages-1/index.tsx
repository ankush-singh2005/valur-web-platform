import svgPaths from "./svg-0dag1dfjw9";
import imgAp1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq from "./965dad945e91d996761aa735c2a2146ce99dc59e.png";
import imgContainer from "./3106d9720f225c6f27be4b93884062b0dc013f93.png";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[88px] items-start min-w-px relative" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] min-h-px not-italic relative text-[#d7ff00] text-[64px] tracking-[-2px] uppercase w-[247px]">
        <p className="leading-[32px]">MY PACKAGES</p>
      </div>
    </div>
  );
}
...
function HeaderTitle() {
  return (
    <div className="absolute content-stretch flex h-[88px] items-center left-[16px] right-[16px] top-0" data-name="Header Title">
      <Heading />
    </div>
  );
}
  ...
  return (
    <div className="bg-[#0b0c0e] content-stretch flex flex-col items-center justify-center px-[20px] py-[8px] relative rounded-[12px] shrink-0" data-name="Button">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#e2e2e5] text-[13px] text-center uppercase whitespace-nowrap">
        <p className="leading-[20px]">DRAFTS</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#0b0c0e] content-stretch flex flex-col items-center justify-center px-[20px] py-[8px] relative rounded-[12px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#e2e2e5] text-[13px] text-center uppercase whitespace-nowrap">
        <p className="leading-[20px]">ARCHIVED</p>
      </div>
    </div>
  );
}
...
function FilterChips() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[44px] items-start left-[16px] overflow-auto pb-[8px] top-[88px] w-[358px]" data-name="Filter Chips">
      <Button />
      <Button1 />
      <Button2 />
    </div>
...
function Ap1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AP1WRLuPpCuwGy9KHx8lgGHbeVtEyphobbhIm6mUBtLhgQ7HAuQ8e0faGOMtcYXClc_mcBMV4rSFVtRW2sO56prl99mE86jSUBa9oWVDxPAwQeSlv1_WP5o6X1OnNSrCLJUqN8auGq2gUvjaMUxVJVDxxJKtxzGYydXJ8eOp4B6u9uPJqULZrPuLshEQ6Tow66zFsRtaX-TV_xSr1fLBwoasMkuFZQ7Hku5HzCAFUeKd-FW13ci7lf5aYk25FYkq">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAp1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq} />
    </div>
  );
}
...
function Background() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start px-[6px] py-[2px] relative rounded-[12px] shrink-0" data-name="Background">
      <Frame1 />
    </div>
  );
}
...
function Background1() {
  return (
    <div className="bg-[rgba(251,191,36,0.2)] relative rounded-[12px] self-stretch shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#fbbf24] text-[10px] tracking-[-0.5px] whitespace-nowrap">
          <p className="leading-[15px]">HYBRID</p>
        </div>
      </div>
    </div>
  );
...
function Container4() {
  return (
    <div className="absolute content-stretch flex gap-[4px] items-start left-[12px] top-[12px] w-[95px]" data-name="Container">
      <Background />
      <Background1 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start mb-[-0.5px] relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#d7ff00] text-[24px] tracking-[1px] uppercase whitespace-nowrap">
        <p className="leading-[30px]">ELITE STRIKER TRAINING</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Container">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
        <p className="leading-[20px]">12 Sessions • 60m</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[196px]" data-name="Container">
      <Heading1 />
      <Container7 />
    </div>
  );
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ccf200] text-[24px] text-right tracking-[0.96px] whitespace-nowrap">
...
function Container5() {
  return (
    <div className="absolute bottom-[12px] content-stretch flex items-end justify-between left-[12px] right-[12px]" data-name="Container">
      <Container6 />
      <Container9 />
    </div>
  );
  ...
  return (
    <div className="h-[192px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        <Ap1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq />
        <div className="absolute bg-gradient-to-t from-[#0e141b] inset-0 opacity-80 to-[rgba(14,20,27,0)] via-1/2 via-[rgba(14,20,27,0)]" data-name="Gradient" />
        <Container4 />
        <Container5 />
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Container">
          <path d={svgPaths.p3189a600} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
        <p className="leading-[16px]">Capacity: 12</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ccf200] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[16px]">Edit Details</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">
          <p className="leading-[15px]">AVG RATING</p>
        </div>
      </div>
    </div>
  );
...
function Container19() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[1.99px] items-center justify-center relative size-full">
        <Container20 />
        <Container21 />
      </div>
    </div>
...
function Container23() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">
        <p className="leading-[15px]">TOTAL EARNED</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ccf200] text-[24px] text-center tracking-[0.72px] whitespace-nowrap">
        <p className="leading-[28px]">2L ISK</p>
      </div>
    </div>
  );
}
...
function HorizontalBorder() {
  return (
    <div className="gap-x-[8px] gap-y-[8px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[_47px] pt-[17px] relative shrink-0 w-full" data-name="HorizontalBorder">
...
function ArticlePackageCard() {
  return (
    <div className="backdrop-blur-[10px] bg-[rgba(17,19,21,0.8)] relative rounded-[12px] shrink-0 w-full" data-name="Article - Package Card 1">
...
function Ap1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AP1WRLuPpCuwGy9KHx8lgGHbeVtEyphobbhIm6mUBtLhgQ7HAuQ8e0faGOMtcYXClc_mcBMV4rSFVtRW2sO56prl99mE86jSUBa9oWVDxPAwQeSlv1_WP5o6X1OnNSrCLJUqN8auGq2gUvjaMUxVJVDxxJKtxzGYydXJ8eOp4B6u9uPJqULZrPuLshEQ6Tow66zFsRtaX-TV_xSr1fLBwoasMkuFZQ7Hku5HzCAFUeKd-FW13ci7lf5aYk25FYkq">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgAp1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq} />
    </div>
...
function Background3() {
  return (
    <div className="bg-[#192a50] relative rounded-[12px] self-stretch shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#60a5fa] text-[10px] tracking-[-0.5px] whitespace-nowrap">
...
function Container25() {
  return (
    <div className="h-[192px] relative shrink-0 w-full z-[2]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        <Ap1WrLuPpCuwGy9KHx8LgGHbeVtEyphobbhIm6MUBtLhgQ7HAuQ8E0FaGoMtcYxClcMcBmv4RSfVtRw2SO56Prl99ME86JSuBa9OWvDxPAwQeSlv1Wp5O6X1OnNSrCljUqN8AuGq2GUvjaMUxVjvDxxJKtxzGYydXj8EOp4B6U9UPJqUlZrPuLshEq6Tow66ZFsRtaXTvXSr1FLBwoasMkuFzq7Hku5HzCafUeKdFw13Ci7Lf5AYk25FYkq1 />
        <div className="absolute bg-gradient-to-t from-[#0e141b] inset-0 opacity-80 to-[rgba(14,20,27,0)] via-1/2 via-[rgba(14,20,27,0)]" data-name="Gradient" />
        <Container26 />
        <Container27 />
      </div>
...
function Container36() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
        <p className="leading-[16px]">Capacity: 1:1 Elite</p>
      </div>
    </div>
  );
}
...
function ArticlePackageCard2() {
  return (
    <div className="backdrop-blur-[10px] bg-[rgba(17,19,21,0.8)] relative rounded-[12px] shrink-0 w-full" data-name="Article - Package Card 3">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container25 />
        <Container32 />
      </div>
...
function Background5() {
  return (
    <div className="bg-[#d7ff00] relative rounded-[12px] self-stretch shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col items-start px-[8px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-black tracking-[-0.5px] whitespace-nowrap">
...
function Container48() {
  return (
    <div className="absolute content-stretch flex gap-[4px] items-start left-[12px] top-[12px]" data-name="Container">
      <Background4 />
      <Background5 />
    </div>
  );
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start mb-[-0.5px] relative shrink-0 w-full" data-name="Heading 3">
      <div className="[word-break:break-word] flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#d7ff00] text-[24px] tracking-[1px] uppercase w-[245px]">
        <p className="leading-[30px]">TACTICAL ANALYSIS MASTERCLASS</p>
      </div>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Container">
      <Container51 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
        <p className="leading-[20px]">4 Workshops • 90m</p>
      </div>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[12px] top-[100.5px] w-[245px]" data-name="Container">
      <Heading3 />
      <Container50 />
    </div>
  );
...
function Container52() {
  return (
    <div className="absolute content-stretch flex flex-col items-end left-[240px] top-[144px]" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ccf200] text-[24px] text-right tracking-[0.96px] whitespace-nowrap">
...
function Container57() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13px] text-white whitespace-nowrap">
        <p className="leading-[16px]">Capacity: Small Group (4)</p>
      </div>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ccf200] text-[24px] text-center tracking-[0.72px] whitespace-nowrap">
        <p className="leading-[28px]">5L ISK</p>
      </div>
    </div>
  );
}
...
function ArticlePackageCard1() {
  return (
    <div className="backdrop-blur-[10px] bg-[rgba(17,19,21,0.8)] relative rounded-[12px] shrink-0 w-full" data-name="Article - Package Card 2">
      <div className="content-stretch flex flex-col isolate items-start overflow-clip p-px relative rounded-[inherit] size-full">
        <Container47 />
        <Container53 />
      </div>
...
function PackageList() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[16px] pt-[8px] right-[16px] top-[132px]" data-name="Package List">
      <ArticlePackageCard />
      <ArticlePackageCard2 />
      <ArticlePackageCard1 />
    </div>
...
function Button6() {
  return (
    <div className="absolute bg-[#ccf200] content-stretch drop-shadow-[0px_4px_10px_rgba(204,242,0,0.4),0px_0px_20px_rgba(204,242,0,0.12)] flex items-center justify-center left-[325px] rounded-[26px] size-[52px] top-[829px]" data-name="Button">
      <Icon3 />
    </div>
  );
}
...
function Main() {
  return (
    <div className="absolute h-[968px] left-0 right-0 top-[54px]" data-name="Main">
      <HeaderTitle />
      <FilterChips />
      <PackageList />
      <Button6 />
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[19.975px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.975 20">
        <g id="Container">
          <path d={svgPaths.p2114d300} fill="var(--fill-0, #D7FF00)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function HtmlBody() {
  return (
    <div className="absolute h-[1155px] left-0 top-0 w-[390px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(0, 0, 0) 0%, rgb(0, 0, 0) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="Html → Body">
      <Container />
      <Main />
...
export default function MyPackages() {
  return (
    <div className="bg-white relative size-full" data-name="MY PACKAGES">
      <div className="absolute backdrop-blur-[4px] bg-[rgba(0,0,0,0)] content-stretch flex flex-col h-[54px] items-start left-0 pt-[21px] px-[24px] top-0 w-[390px]" data-name="Status Bar - iPhone">
        <Frame />
      </div>
      <HtmlBody />
    </div>
