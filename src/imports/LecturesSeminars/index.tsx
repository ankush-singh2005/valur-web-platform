import svgPaths from "./svg-fndyuifx4v";
...
function Heading() {
  return (
    <div className="absolute h-[88px] left-0 right-0 top-0" data-name="Heading 2">
      <div className="[word-break:break-word] absolute bottom-0 flex flex-col font-['Bebas_Neue:Regular',sans-serif] justify-center leading-[0] left-[16px] not-italic text-[#d7ff00] text-[64px] top-0 tracking-[-2px] uppercase w-[247px]">
        <p className="leading-[32px]">LEARN</p>
      </div>
    </div>
  );
}
...
function HeaderTitle() {
  return (
    <div className="absolute h-[88px] left-0 top-[54px] w-[358px]" data-name="Header Title">
      <Heading />
    </div>
  );
}
...
function SegWrap() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 overflow-clip pb-[14px] pt-[8px] px-[16px] right-0 top-[8px]" data-name="SegWrap">
      <Container9 />
    </div>
  );
}
...
function FilterChips() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[60px] items-start left-0 overflow-auto pb-[16px] pt-[8px] px-[16px] right-0 top-[78px]" data-name="Filter Chips">
      <Button />
      <Button1 />
      <Button2 />
    </div>
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-[#0e0f11] h-[360px] relative rounded-[16px] shrink-0 w-full" data-name="Background+Border+Shadow">
  ...
  return (
    <div className="h-[12.852px] relative shrink-0 w-[11.648px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.6484 12.8516">
        <g id="Container">
          <path d={svgPaths.pb0d4120} fill="var(--fill-0, #D7FF00)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col items-center left-0 pt-[16px] top-[138px] w-[390px]">
      <Frame11 />
    </div>
  );
}
...
function Body() {
  return (
    <div className="absolute h-[1113px] left-0 overflow-clip right-0 top-[142px]" data-name="Body">
      <SegWrap />
      <FilterChips />
      <Frame5 />
    </div>
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[22px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 16">
        <g id="Container">
          <path d={svgPaths.p378800} fill="var(--fill-0, #D7FF00)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
export default function LecturesSeminars() {
  return (
    <div className="relative size-full" data-name="LECTURES & SEMINARS">
      <StatusBar />
      <HeaderTitle />
      <Body />
